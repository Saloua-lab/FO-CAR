 ...
 *   Step 3  Choquet Integral-based Neighbor Selection 
 *
 * Dataset: LDOS-CoMoDa (5 context dims; ratings 1-5)
 * CSV column indices used: [0]=userId, [1]=itemId, [2]=rating,
 *   [7]=time, [10]=location, [11]=weather, [12]=social, [15]=mood
 */
public class RecomMain2_FOCAR_LDOS{

    static String DATA_CSV = "D:\\datasets\\LDOS-CoMoDa2.csv";
    static String OUT_FILE = "D:\\datasets\\LDOS_FOCARS_CV.txt";

    // Context columns in the CSV (must match N_DIMS)
    ...
    static double EPSILON   = 0.1;  // 1/N_DIMS=0.2 for 5 dims

    private static double[] lastMetrics;

    //  MAIN
    public static void main(String[] args) throws Exception {
        System.out.println("=== FO-CAR LDOS-CoMoDa  ===\n");
        ...
        StringBuilder sb = new StringBuilder("=== FO-CAR LDOS-CoMoDa RESULTS ===\n");
        for (int m = 0; m < 10; m++) {
    ...
    //  Data loading reads specific columns for LDOS-CoMoDa CSV
