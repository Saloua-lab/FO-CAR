...
/** Diagnostic only: AUC/MAE/RMSE/fallback-split for FullCtx (r^C) on DePaulMovie_clean.csv (single 80/20 split, seed=1). */
public class FullCtxMetrics_Movie {
    static int N_DIMS = 3;
    static int NEG_SAMPLE = 1000;
    static int RATING_THRESHOLD = 4;

    public static void main(String[] args) throws Exception {
        ArrayList<int[]> all = loadData("DePaulMovie_clean.csv");
