...
/** Diagnostic only: AUC for FullCtx (r^C) on LDOS-CoMoDa.csv (single 80/20 split, seed=1). */
public class FullCtxMetrics_LDOS {
    static int N_DIMS = 5;
    static final int[] CTX_COLS = {7, 10, 11, 12, 15};
